...
public class EnemyController : MonoBehaviour
{
    ...
    private void FixedUpdate(){
        ...
        if (animator.GetBool("isAttacking") && animator.GetCurrentAnimatorStateInfo(0).normalizedTime < 1f){
            print(animator.GetCurrentAnimatorStateInfo(0).normalizedTime);
            PlayerCamera.transform.position = AttackEyes.transform.position + PlayerEyes.transform.TransformDirection(new Vector3(0, 0, 0.2f));
        }else {
