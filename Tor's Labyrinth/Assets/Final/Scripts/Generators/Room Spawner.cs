...
public class RoomSpawner : MonoBehaviour
{
    ...
    public static int l2T = 0;
    public static Vector3 l2Pos = new Vector3(0, -34, 0);
    ...
    void Spawn()
    {
        if (!spawned){
            ...
            if ((isSpace.isSpace && roomsSpawned >= 6 && !l1)){
                Instantiate(landmark1[openingDirection-1], transform.position, landmark1[openingDirection-1].transform.rotation);
                l1 = true;
            } else if (isSpace.isSpace && l2T < 2 && Vector3.Distance(transform.position, l2Pos) > 90f && Vector3.Distance(transform.position, new Vector3(0, -34, 0)) > 80f){
